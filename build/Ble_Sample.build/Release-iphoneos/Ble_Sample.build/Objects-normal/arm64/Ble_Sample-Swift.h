...
#ifndef BLE_SAMPLE_SWIFT_H
#define BLE_SAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Ble_Sample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Ble_Sample11AppDelegate")
...
SWIFT_CLASS("_TtC10Ble_Sample10BLEManager")
...
///
/// \param RSSI The signal strength of the discovered peripheral, in decibels.
///
...
SWIFT_CLASS("_TtC10Ble_Sample29CharacteristicsViewController")
...
@interface CharacteristicsViewController (SWIFT_EXTENSION(Ble_Sample)) <CBPeripheralDelegate>
...
/// \param peripheral The peripheral providing this information.
///
/// \param characteristic The characteristic whose value has been updated.
///
/// \param error If an error occurred, the cause of the failure.
///
...
@interface CharacteristicsViewController (SWIFT_EXTENSION(Ble_Sample)) <UITableViewDataSource, UITableViewDelegate>
...
///
/// returns:
/// An object representing a cell of the table.
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
/// Tells the delegate that the specified row is now selected.
/// \param tableView The table view informing the delegate about the new row selection.
///
/// \param indexPath The index path locating the selected row in the table view.
///
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


SWIFT_CLASS("_TtC10Ble_Sample27NotifiedValueViewController")
@interface NotifiedValueViewController : UIViewController
- (void)viewDidLoad;
- (void)dismissView;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10Ble_Sample13SceneDelegate")
...
SWIFT_CLASS("_TtC10Ble_Sample22ServicesViewController")
...
@interface ServicesViewController (SWIFT_EXTENSION(Ble_Sample)) <CBPeripheralDelegate>
...
@interface ServicesViewController (SWIFT_EXTENSION(Ble_Sample)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC10Ble_Sample14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(Ble_Sample)) <UITableViewDataSource, UITableViewDelegate>
...
///
/// returns:
/// The number of rows in the section.v
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
/// Provides a cell object for the specified row in the table view.
/// \param tableView The table view requesting the cell.
///
...
@interface ViewController (SWIFT_EXTENSION(Ble_Sample)) <CBCentralManagerDelegate, CBPeripheralDelegate>
